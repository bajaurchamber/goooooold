          ...
          <div className="lg:w-2/3 order-2 lg:order-1">
            ...
            >
              ...
              <motion.div 
                ...
                animate={{
                  background: `linear-gradient(135deg, ${services[activeService].gradient.includes('yellow') ? '#F59E0B' : services[activeService].gradient.includes('amber') ? '#D97706' : '#EA580C'}40, transparent, ${services[activeService].gradient.includes('yellow') ? '#F59E0B' : services[activeService].gradient.includes('amber') ? '#D97706' : '#EA580C'}30)`,
                }}
              >
