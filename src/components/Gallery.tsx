      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <motion.button
                    ...
                    className={`flex-1 max-w-[140px] px-4 py-3 rounded-xl font-semibold text-sm transition-all duration-300 border-2 ${
                      filter === category
                        ...
                        : 'bg-white/10 text-white/80 border-yellow-400/30 hover:border-yellow-400 hover:bg-white/20 hover:text-white'
                    }`}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6 lg:gap-8">
          {filteredImages.map((image, index) => (
            <motion.div 
              key={`${image.src}-${index}`}
              className="group relative bg-white/5 rounded-2xl overflow-hidden cursor-pointer border-2 border-yellow-400/30 hover:border-yellow-400 transition-all duration-300 flex flex-col h-full"
            ...
            >
              ...
              <div className="relative h-48 sm:h-56 lg:h-64 overflow-hidden flex-shrink-0">
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="w-12 h-12 bg-yellow-400/20 rounded-full flex items-center justify-center backdrop-blur-sm border-2 border-yellow-400">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-black/60 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-medium border border-yellow-400/50">
                    {image.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-4 lg:p-6 border-t border-yellow-400/20 flex flex-col flex-grow">
