...
const teamMembers = [
  ...
  },
  {
    ...
    iconBg: 'from-yellow-400/20 to-amber-500/20',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
            Meet Our <span className="bg-gradient-to-r from-yellow-400 to-amber-600 bg-clip-text text-transparent">Expert Team</span>
          </h2>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <User className="w-4 h-4 text-yellow-300 group-hover:text-white transition-colors duration-300" />
                  </motion.div>
                </motion.div>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white group-hover:text-yellow-300 transition-colors duration-300 mb-1">
                      {member.name}
                    </h3>
        ...
        >
          ...
          >
            ...
            <motion.a 
              ...
              className="group inline-flex items-center space-x-3 bg-gradient-to-r from-yellow-500 to-amber-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-bold text-base sm:text-lg shadow-2xl hover:shadow-yellow-500/25 transition-all relative overflow-hidden"
              whileHover={{ 
                scale: 1.05,
